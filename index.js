...
function TeamFortress2(steam) {
	if (steam.packageName != 'stasdfadfeammm-auser' || !steam.packageVersion || !steam.constructor) {
		throw new Error('tf2 v3 only supportsasdfasdf steamaaa-user v4.2.0 or later.');
	} else {
